      ...
      items: [
        {
          ...
          link: { type: "generated-index", title:"Confidential x402", slug: "finance-solutions/x402/", description: "Confidential x402 is a privacy extension to the x402 payment protocol that hides payment amounts and balances on-chain using ZK proofs and MPC — without changing how you write HTTP clients or servers." },
          items: [
