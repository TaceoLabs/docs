    ...
    [
      require.resolve("@docusaurus/plugin-client-redirects"),
      {
        redirects: [
          ...
          { from: "/docs/use-cases/ai", to: "/docs/use-cases/" },
          { from: "/docs/use-cases/defi", to: "/docs/use-cases/" },
          { from: "/docs/use-cases/data-ownership", to: "/docs/use-cases/" },
          { from: "/docs/use-cases/gaming", to: "/docs/use-cases/" },
        ],
      },
    ],
  ],
