...
2. **State transitions are cryptographically secured and verified onchain via CoSNARKs (TODO reference).** Both the client's spending proof and
...
[How it works](/docs/x402/how-it-works), which uses the x402 payment as the worked example but
...
|---|---|---|---|
| **Confidential** | Amounts, balances | Sender and receiver wallet addresses | You want to hide pricing or amounts but settle to known counterparty wallets. The basis for [Confidential x402](/docs/x402/introduction). |
...
| Compliance dashboard with selective disclosure | 🟢 Live | [Compliance](/docs/finance-solutions/compliance/overview) |
| `transferWithAuthorization` (basis for [Confidential x402](/docs/x402/introduction)) | 🟢 Live | [x402 App](https://confidential-x402.taceo.io/) |
| Allowlists at the contract layer | 🟢 Live | - |
| Private yield |  🟢 Live | [Private Yield](/docs/finance-solutions/private-defi/private-yield) |
