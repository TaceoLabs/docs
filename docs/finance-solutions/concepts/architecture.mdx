...
**Onchain privacy.** What each mode reveals, and to whom, is set out in [What you see onchain](./what-you-see-onchain).

**Speed.** Collaborative proving gets proof-market performance without exposing plaintext data to the prover. Current throughput per mode is in [Privacy model](./privacy-model).
