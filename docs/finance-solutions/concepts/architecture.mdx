...
**Onchain privacy.** Concealing sensitive data like involved wallet addresses and transaction amounts from the public. What each mode reveals, and to whom, is set out in [Who sees what](/docs/finance-solutions/concepts/who-sees-what).
