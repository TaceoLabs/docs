...
![Private Transfer Architecture](private-transfer-arch-transparent.png)
...
**Onchain privacy.** Concealing sensitive data like involved wallet addresses and transaction amounts from the public. What each mode reveals, and to whom, is set out in [Privacy Model](/docs/finance-solutions/concepts/privacy-model).

**Speed.** Collaborative proving outperforms client-side proving due to the use of stronger machines, without exposing plaintext data to the prover.
