...
| Contract | Address |
|---|---|
| Merces Contract | `0xTODO` |
| Confidential USDC token | `0xTODO` |
...
| Service | URL |
|---|---|
| Faucet | `https://faucet.merces.taceo.io` |
| Facilitator | `https://facilitator.merces.taceo.io` |
| Resource server (test) | `https://resource.merces.taceo.io` |
| MPC node 0 | `https://node0.merces.taceo.io` |
| MPC node 1 | `https://node1.merces.taceo.io` |
| MPC node 2 | `https://node2.merces.taceo.io` |
...
```bash
curl -X POST https://faucet.merces.taceo.io/claim/0xYourWalletAddress
```
...
```bash
curl https://facilitator.merces.taceo.io/supported
```
