...
**Facilitator** — an off-chain service that verifies payment proofs and triggers settlements. It
...
sequenceDiagram
    ...
    Note over C: Generate commitment, secret shares,<br/>ciphertexts, EIP-712 signature,<br/>Groth16 proof
...
| Operation | Cost |
|---|---|
| Proof generation (client) | ~800ms (SnarkJS) / ~60ms (Rust) |
| On-chain proof verification (client proof) | ~800,000 gas |
| On-chain proof verification (server proof) | ~1,100,000 gas |
