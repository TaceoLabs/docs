...
into a shielded form. Balances are held as secret shares across the TACEO Network, state
...
|---|---|---|
| **Confidential payments** | Hide amounts and balances. Sender and receiver visible. | Live on Arc and Base testnets. Demo: [merces-dashboard.taceo.io/arc](https://merces-dashboard.taceo.io/arc). |
| **Fully private payments** | Hide amounts, balances, sender, and receiver. | Live on Plasma testnet. Demo: [merces.taceo.io](https://merces.taceo.io). |
...
Shielded ERC-20 transfers on the EVM chain you already use. Users get a private virtual account
...
Compliant private yield on Ethereum. Earn on shielded balances without exposing positions,
...
Confidential swaps, dark pools, and approvals. Brings the shielded-balance model to swap
