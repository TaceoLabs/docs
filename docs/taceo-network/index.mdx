...
<div style={{padding: '1rem', backgroundColor: 'var(--ifm-color-emphasis-100)', borderRadius: '8px'}}>
**Understand the system**
<br/>
<Link to="/docs/taceo-network/network#how-the-network-works">How the Network Works</Link>
<br/>
<Link to="/docs/taceo-network/network#interacting-with-the-network">Interacting with the Network</Link>
</div>

<div style={{padding: '1rem', backgroundColor: 'var(--ifm-color-emphasis-100)', borderRadius: '8px'}}>
**Review trust and safety**
<br/>
<Link to="/docs/taceo-network/network#security-model">Security Model</Link>
<br/>
<Link to="/docs/taceo-network/network#network-governance">Network Governance</Link>
</div>
...
<br/>
<Link to="/docs/taceo-network/network#privacy-services">Privacy Services on the Network</Link>
</div>
