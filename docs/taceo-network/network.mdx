...
The network has already been running production workloads for months, including biometric identity uniqueness verification at global scale through **World**, securing over 18 million users.
...
The TACEO Network executes requests through privacy services running on committees of independent MPC nodes.
