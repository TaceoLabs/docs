...
Want to build your own authorization logic? Learn about [Authorization Modules](/docs/services/taceo-oprf/authorization).

### Integration  
Ready to integrate into your application? Check the [API Reference](/docs/services/taceo-oprf/api).

### Use Cases
Looking for inspiration? Explore our [Use Cases & Examples](/docs/identity-solutions/nullifiers/use-cases).
...
- **Production Deployment**: [Contact us](mailto:partnerships@taceo.io) to discuss production use