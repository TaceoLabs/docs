...
A demo is available [here](https://confidential-x402.taceo.io).
...
Merces also supports a **private mode** that hides sender and receiver addresses as well. Exposing private mode through the x402 scheme is planned
...
| See what the confidential scheme is good for | [Use cases](/docs/x402/use-cases) |
