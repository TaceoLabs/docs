...
{/* TODO(lukas): merge into the production and testnets table above so that one can easily see which frontend points to which deployment.
For e.g. Worldchain Mainnet we can state sth like 'access enabled via ClientSDK' */}
