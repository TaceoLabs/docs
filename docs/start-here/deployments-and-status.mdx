...
- **ZKPassport.** Live in production since September 1, 2026 — the second production deployment of TACEO:OPRF, after World. Proves age, nationality, and humanity directly from a passport's NFC chip via a nullifier the network computes under a 2-of-3 secret-shared key; nothing sensitive leaves the user's device.
