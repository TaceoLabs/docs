...
Problem: ZK identity systems like World ID and zkPassport rely on single secret keys. If leaked, your entire history is exposed.
...
*Used in: World ID, zkPassport, anonymous voting, private credentials*
