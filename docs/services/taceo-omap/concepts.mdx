...
This page describes the cryptographic building blocks that underpin TACEO:OMap. For foundational reading: secret sharing, zero-knowledge proofs and MPC protocols are covered in [the glossary](/docs/start-here/glossary) and collaborative SNARKs (coSNARKs) in the [coSNARKs primer](/docs/primer/collabSNARKs-primer).
