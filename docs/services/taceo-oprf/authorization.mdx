...
- [Simple auth module](https://github.com/TaceoLabs/oprf-testnet/blob/c143033ee820f46eef8714d472d6c0e9c1e5eab0/oprf-testnet-authentication/src/lib.rs#L222)
- [Wallet auth module](https://github.com/TaceoLabs/oprf-testnet/blob/c143033ee820f46eef8714d472d6c0e9c1e5eab0/oprf-testnet-authentication/src/lib.rs#L192)
...
- Ready to build? Check out the [Quickstart](/docs/identity-solutions/nullifiers/getting-started/quickstart)
- Need examples? See [Use Cases & Examples](/docs/identity-solutions/nullifiers/use-cases)
- Technical details? Review the [API Reference](/docs/services/taceo-oprf/api)